# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-03-31 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crt_bat', otree.db.models.PositiveIntegerField(null=True, verbose_name='\n        A bat and a ball cost 22 dollars in total.\n        The bat costs 20 dollars more than the ball.\n        How many dollars does the ball cost?')),
                ('crt_widget', otree.db.models.PositiveIntegerField(null=True, verbose_name='\n        "If it takes 5 machines 5 minutes to make 5 widgets,\n        how many minutes would it take 100 machines to make 100 widgets?"\n        ')),
                ('crt_lake', otree.db.models.PositiveIntegerField(null=True, verbose_name='\n        In a lake, there is a patch of lily pads.\n        Every day, the patch doubles in size.\n        If it takes 48 days for the patch to cover the entire lake,\n        how many days would it take for the patch to cover half of the lake?\n        ')),
